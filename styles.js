...
//limitar el número de dígitos y lugares decimales
...
//se activa cuando se presiona un boton
function perform(m)
{
...
//funcion para botones especiales
function sperform(m)
{
	switch(m)
	{
		...
		case 'bs':
			if((a!="")&&(sign!=""))
			{
				...
				else//b has some value-//b tiene algún valor
				{
					var bx= new Array();
					bx=b.split("");
					bx.pop();
